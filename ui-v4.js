(() => {
  ...
  function render() {
    ...
    if (state.dice && newRoll) {
      const entries = [
        ...state.dice.white.map((value, index) => ({ value, color: 'white', rerollIndex: canReroll && (state.cyclingDie === null || state.cyclingDie === index) ? index : null })),
