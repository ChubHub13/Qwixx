(() => {
  ...
  $('#players').innerHTML=names.map(n=>`<button data-player="${n}">${n}</button>`).join(''); document.querySelectorAll('#players button').forEach(button=>button.onclick=()=>join(button.dataset.player));
