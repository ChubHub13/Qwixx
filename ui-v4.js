(() => {
  ...
  document.head.insertAdjacentHTML('beforeend', '<style>#return{z-index:10000!important;pointer-events:auto!important}.players{grid-template-columns:repeat(3,1fr)}.players .join-seat{display:grid;grid-template-columns:minmax(0,1fr) 27px;gap:5px}.players .join-seat button{min-width:0}.players .join-name-edit{padding:0;font-size:16px}.seat-name{display:flex;align-items:center;gap:3px}.seat .name-edit{display:grid;place-items:center;width:16px;height:16px;padding:0;border:0;border-radius:50%;background:#3a1949;color:#fff0b4;font:900 11px/1 system-ui,sans-serif;cursor:pointer}.seat .name-edit:hover{background:#754261}</style>');
