(() => {
  ...
  document.head.insertAdjacentHTML('beforeend', `<style>
    ...
    @media (min-width:581px) and (max-width:1100px){.shell{min-height:calc(100svh - 61px)}.table{height:calc(100svh - 69px);min-height:0!important;margin:4px;border-radius:24px}.boards{inset:42px 10px 8px;grid-template-rows:165px 1fr 170px;gap:7px}.board{width:95%;padding:4px;border-width:3px}.board.bottom{width:52%}.row{margin:2px 0}.cell,.cell.mark{height:24px!important;font-size:16px!important}.row-score,.row-lock{height:24px;font-size:12px}.row-lock img{width:13px;height:13px}.board-foot{min-height:28px;padding-top:2px}.seat.under-left{top:215px!important}.seat.under-right{top:215px!important}.seat.beside-bottom{bottom:22px!important;right:calc(50% - 34vw)!important}.roll{width:370px!important;min-height:205px!important;padding:14px!important}.roll h2{margin-bottom:8px}.roll .die{width:46px;height:46px;padding:7px}.dice{gap:8px}}
